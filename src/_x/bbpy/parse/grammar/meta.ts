...
interface AddonOps<C extends AddonOps.CBase> {
  ...
  stringify(...args: [
    subject: AddonOps.ItsRepresentativeInstanceOps<this >, 
    options ?: {} ,
  ]): string ;
...
namespace AddonOps {
   ...
   * 
   */
  export type ItsRepresentativeInstanceOps<This extends Subject<any>> = (
...
namespace AddonOps {
  ...
  export type ItsBufferOpsBase<This extends Subject<any>> = (
    | (
      & ItsRepresentativeInstanceOps<This >
      & SideBufferOpsImpl1
    )
  ) ;
  /** 
   ...
   * 
   */
  export type ItsBuffer<This extends Subject<any>> = (
    BBP.impl.Constructor.InstanceOf<This["Buffer"]>
  ) ;
